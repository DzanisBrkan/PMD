...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ProdajaMobilnihApplikacija.Mobile.Android.dll" comes first in this list. */
		"ProdajaMobilnihApplikacija.Mobile.Android.dll",
		"ProdajaMobilnihAplikacija.Model.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"ProdajaMobilnihApplikacija.Mobile.dll",
