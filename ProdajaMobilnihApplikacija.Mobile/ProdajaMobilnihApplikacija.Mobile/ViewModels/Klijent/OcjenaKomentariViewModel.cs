...
{
    public class OcjenaKomentariViewModel : BaseViewModel
    {
        ...
        public OcjenaKomentariViewModel()
        {
            InitCommand = new Command(async () => await Init());

        }
        public ObservableCollection<Ocjena> OcjenaKomentarList { get; set; } = new ObservableCollection<Ocjena>();
